...
COMPONENT_SOURCE="./pulp_scheduler/dist/pulp_scheduler-${COMPONENT_VERSION}-py3-none-any.whl"
...
---
scenario: "${TEST}"
plugin_name: "pulp_scheduler"
legacy_component_name: "pulp_scheduler"
...
image:
  ...
  webserver_snippet: $(test -f pulp_scheduler/app/webserver_snippets/nginx.conf && echo -n true || echo -n false )
extra_files:
  - origin: "pulp_scheduler"
    destination: "pulp_scheduler"
services:
  - name: "pulp"
    image: "pulp:ci_build"
    volumes:
